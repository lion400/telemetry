...
export default function LoginPage() {
  ...
  const S = {
    ...
    card: {
      width: 420, background: '#0c1829', border: '1px solid #1a3050',
    ...
    logoIcon: {
      width: 40, height: 40, background: '#1a6fff', borderRadius: 10,
      display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20,
    },
    subtitle: {
      fontFamily: "'DM Mono',monospace", fontSize: 10, letterSpacing: 2,
      color: '#3d5a80', textTransform: 'uppercase', marginBottom: 36,
    },
    label: {
      display: 'block', fontFamily: "'DM Mono',monospace", fontSize: 10,
      letterSpacing: 1, color: '#6b8ab0', textTransform: 'uppercase', marginBottom: 6,
    },
    input: {
    ...
    btn: {
      width: '100%', background: '#1a6fff', border: 'none', borderRadius: 8,
    ...
    <div style={S.page}>
      ...
      <div style={S.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* CAPTCHA */}
          <div
            style={{ ...S.captcha, borderColor: captchaChecked ? 'rgba(0,230,118,0.4)' : '#1a3050' }}
            onClick={() => setCaptchaChecked(c => !c)}
          >
            <div style={{
              width: 20, height: 20, borderRadius: 4,
              border: `2px solid ${captchaChecked ? '#00e676' : '#3d5a80'}`,
              background: captchaChecked ? '#00e676' : 'transparent',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              flexShrink: 0, transition: 'all 0.2s',
            }}>
              {captchaChecked && <span style={{ color: '#060d1a', fontSize: 13, fontWeight: 900 }}>✓</span>}
            </div>
            <span style={{ fontSize: 13, color: '#e8f0fe', userSelect: 'none' }}>No soy un robot</span>
        ...
        <div style={S.demo}>
          <strong style={{ color: '#5a9fff' }}>Cuenta demo</strong><br />
          Usuario: <strong style={{ color: '#e8f0fe' }}>admin</strong>
          &nbsp;·&nbsp;
          Contraseña: <strong style={{ color: '#e8f0fe' }}>Admin2024!</strong>
        </div>
      </div>
    </div>
  )
